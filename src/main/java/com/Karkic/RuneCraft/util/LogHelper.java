...
import com.Karkic.RuneCraft.RuneCraft;
import com.Karkic.RuneCraft.handler.ConfigurationHandler;
...
public class LogHelper {
    ...
    public static final Marker MOD_MARKER = MarkerManager.getMarker(RuneCraft.Mod_ID);
    private static final Logger LOGGER = LogManager.getLogger(RuneCraft.Mod_ID);
